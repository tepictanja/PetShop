...
namespace PetShop
{
    public partial class AzurirajCijenuForm : Form
    {
        public Tema tema { get; set; }
        public int idTeme;

        public AzurirajCijenuForm()
        {
            InitializeComponent();
        ...
        {
            DB_PetShop.AzurirajCijenu(Int32.Parse(tbSifra.Text), Int32.Parse(tbCijena.Text));
            MessageBox.Show("Cijena je azurirana!", "Poruka", MessageBoxButtons.OK, MessageBoxIcon.Information);
            this.Close();
        }
    }
}
